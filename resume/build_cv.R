...
system("pandoc cv.md -o cv.pdf -V geometry:margin=0.25in -H cvlink_header.tex -V fontsize=8pt -V linestretch=0.8 -V colorlinks=true -V textcolor=darkgray -V documentclass=article --pdf-engine=xelatex")
