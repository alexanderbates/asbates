---
title: "Alexander Shakeel Bates, PhD, FRES - CV"
author: Alexander Shakeel Bates, PhD, FRES
date: "`r Sys.Date()`"
params:
  pdf_mode:
    value: false
...
# Google Scholar mislabels the PhD thesis as a "Genomics" paper; exclude it (it is the thesis, listed under Education).
...
# Update BANC connectome paper (now published in Nature)
...
# Add 1 Nature Comm. review not yet on ORCID
peer_reviews <- peer_reviews %>%
  dplyr::mutate(reviews = ifelse(journal == "Nature Comm.", reviews + 1, reviews))
...
Alexander Shakeel Bates, PhD, FRES {#title}
--------------------------------------------------------------------------------
