...
- <i class="fas fa-tools"></i> [ConnectomeInfluenceCalculator](https://zenodo.org/records/17693838)
...
df$peer_reviews <-  sum(peer_reviews$reviews) + 9  # Add 9 abstract reviews (e.g., COSYNE 2026)
