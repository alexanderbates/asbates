...
<i class="fas fa-tools"></i> [bancr](https://github.com/flyconnectome/bancr) - author
...
formattable(reviews, list(
  ...
  cites = color_bar("#EBB7a1", fun = "normalize"),
...
formattable(publications, list(
  position = FALSE, # color_bar("lightgreen", fun = "normalize"),
  cites = color_bar("#EBB7a1", fun = function(x) min(c(x,100))/100),
  IF = FALSE, # color_bar("lightblue", fun = "normalize"),
  number = FALSE,
  cid = FALSE,
  pubid = FALSE))
...
Peer Reviews {data-icon=chalkboard-teacher}
--------------------------------------------------------------------------------
