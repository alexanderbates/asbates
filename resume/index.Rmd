...
<br></br>
<br></br>
- <i class="fas fa-user-graduate"></i> BSc Tutor at UCL: Dr. Marco Beato, UCL Neuroscience, Physiology and Pharmacology, [m.beato@ucl.ac.uk](m.beato@ucl.ac.uk])
<br></br>
<br></br>
- <i class="fas fa-user-astronaut"></i> Supervisee: Serene Dhawan, Princeton, PhD student, [serenedhawan @gmail.com](serenedhawan@gmail.com])
...
Updated on `r format(Sys.Date(), format = "DD-MM-YYYY")` 
